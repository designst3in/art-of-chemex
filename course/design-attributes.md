...
```mermaid
flowchart TB
  Filter["7 · Bonded paper filter"] --> Upper["1 · Upper cone"]
  Upper --> Spout["3 · Spout / air channel · US2241368"]
  Upper --> Collar["4 · Wood collar · full-level mark"]
  Collar --> Tie["5 · Leather / rawhide tie"]
  Collar --> Lower["2 · Lower flask · borosilicate"]
  Lower --> Half["6 · Belly-button half-mark"]
  Materials["8 · Wartime materials story"] -.-> Lower
  Materials -.-> Collar
  Materials -.-> Tie
```
